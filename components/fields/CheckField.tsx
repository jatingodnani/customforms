...
const type:ElementType="CheckField";
...
export const CheckfieldFormElement:FormElement={
    type,
    construct:(id:string)=>({
       id,
       type,
...
<Input
 ...
 onChange={(e)=>{const valid=TextfieldFormElement.validate(element,e.target.value)
  seterror(!valid)
